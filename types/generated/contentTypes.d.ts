...
export interface ApiAttendanceLogAttendanceLog
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    device_uid: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiShiftTypeShiftType extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'shift-types';
    singularName: 'shift-type';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    grace_period_minutes: Schema.Attribute.Integer;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    shift_end: Schema.Attribute.Time;
    shift_name: Schema.Attribute.String;
    shift_start: Schema.Attribute.Time;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_id: Schema.Attribute.Integer;
...
export interface ApiUserAccountUserAccount extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    card_no: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiUserWeekdayShiftUserWeekdayShift
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_weekday_shifts';
  info: {
    displayName: 'UserWeekdayShift';
    pluralName: 'user-weekday-shifts';
    singularName: 'user-weekday-shift';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-weekday-shift.user-weekday-shift'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    shift_type_id: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_id: Schema.Attribute.Integer;
